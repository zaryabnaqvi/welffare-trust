                        ...
                        <div className='row'>
                            <div data-aos="fade-right" data-aos-duration="700" className='col-sm-12 col-md-12 col-lg-6 justify-content-center'>
                                <div style={{} } className="text-left">
                                    ...
                                    <div  className="hussainlandpara"  style={{color: '#786666'}}>Hussain's Shrine, Karbala (Iraq) <br />Millions of people from all over the world visit the shrine Hussain in Iraq to pay their respects.</div>
