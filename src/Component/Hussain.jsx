...
export default function Hussain() {
    document.title='Who Is Hussain? - Aza-e-Hussain Trust of Halifax'
    useEffect(() => {
...
<Helmet>
        <title>Who Is Hussain? - Aza-e-Hussain Trust of Halifax</title>
        <link rel="icon" href={"path-to-your-favicon"}/>
        <meta name="description" content="Learn about Hussain, a revolutionary leader from the seventh century."/>
        <meta name="keywords" content="Hussain, Revolutionary Leader, Moral Fairness, Just Society, Legacy"/>
        <meta property="og:title" content="Who Is Hussain? - Aza-e-Hussain Trust of Halifax"/>
        <meta property="og:description" content="Learn about Hussain, a revolutionary leader from the seventh century."/>
      </Helmet>
